// Vendored from https://telegram.org/js/telegram-web-app.js on 2026-09-10.
// Served from our own origin because telegram.org is filtered by some Russian ISPs:
// the request hangs with no error, and a script waited on is a screen that never loads.
// Re-check against the original every few months.
// WebView
(function () {
  var eventHandlers = {};
