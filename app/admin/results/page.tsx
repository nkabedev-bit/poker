...
export default async function ResultsPage({
  ...
  const { data } = await supabase
    ...
    .select("started_at, played_on, title, player_name, place, points, knockouts, telegram_id")
  ...
  const gamesByStart = new Map<string, { players: number; playedOn: string; startedAt: string; title: string }>();
